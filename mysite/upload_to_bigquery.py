...
# Servis hesabı JSON yolu (Easypanel'de GOOGLE_APPLICATION_CREDENTIALS env var olarak ayarlanmalı)
os.environ.setdefault(
    "GOOGLE_APPLICATION_CREDENTIALS",
    os.path.join(BASE_DIR, "deft-citizen-466607-q7-a0a53ceeef2a.json"),
)
...
conn = sqlite3.connect(os.getenv('DATABASE_PATH', os.path.join(BASE_DIR, 'database.db')))
